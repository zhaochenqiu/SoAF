...
%    threshold = rand();
    ...
    result_R_siltp = [result_R_siltp ; tpr pr];
    ...
    result_siltp = [result_siltp ; tpr pr];
...
txtWrite(data_R_siltp,'test1pr.txt');
txtWrite(data_siltp,'test2pr.txt');
...
mydir = './'
name=[imagename '_tRoc.png']; %'pets2006_Re.png';%['\figure',num2str(fighandle),'.png'];
F=getframe(gcf);
...
txtWrite(data_R_siltp,'test3pr.txt');
txtWrite(data_siltp,'test4pr.txt');
...
txtWrite(data_R_siltp,'test5pr.txt');
txtWrite(data_siltp,'test6pr.txt');
