...
F=getframe(gcf);
imwrite(F.cdata,'texture_grayvalue.bmp')
...
ylim([min(list(x))-20 max(list(x))+20])
F=getframe(gcf);
imwrite(F.cdata,'texture_redvalue.bmp')
...
ylim([min(list(x))-20 max(list(x))+20])
F=getframe(gcf);
imwrite(F.cdata,'texture_greenvalue.bmp')
...
ylim([min(list(x))-20 max(list(x))+20])
F=getframe(gcf);
imwrite(F.cdata,'texturebluevalue.bmp')
...
ylim([min(list(x))-20 max(list(x))+20])
F=getframe(gcf);
imwrite(F.cdata,'texture_texturevalue.bmp')
